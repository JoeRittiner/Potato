	...
	data: new SlashCommandBuilder()
		...
		async execute(interaction) {
		    ...
		    case 'disable':
		        ...
		        return await interaction.editReply(':hear_no_evil: Deafened! I will not listen to any messages.');
		    case 'status':
		    ...
		    default:
		        return await interaction.editReply({ content: ':interrobang: Unknown subcommand. Please use a valid subcommand.', flags: MessageFlags.Ephemeral });
		    }
	    }
};